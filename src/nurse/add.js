...
const AddVital = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Before submitting, ensure the userId is present
    if (!userId) {
    ...
    try {
      ...
      // Log the data to verify before sending
      console.log("Submitting with userId:", userId);
      console.log("Form data:", formData);

      // Make sure to include the userId in the variables
      await addVitalSigns({
        variables: {
          userId, // This must not be undefined or null
